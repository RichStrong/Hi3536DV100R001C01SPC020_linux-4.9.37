...
static s32 cryp_hash_initial(cryp_hash_context *hisi_ctx, hash_mode mode)
{
    ...
    switch(mode)
    {
        ...
        case HASH_MODE_SHA384:
        {
            ...
            memcpy_s(&hisi_ctx->hash[0], DOUBLE_WORD_WIDTH, &H0, sizeof(H0));
            H0 = CPU_TO_BE64(SHA384_H1);
            memcpy_s(&hisi_ctx->hash[2], DOUBLE_WORD_WIDTH, &H0, sizeof(H0));
            H0 = CPU_TO_BE64(SHA384_H2);
            memcpy_s(&hisi_ctx->hash[4], DOUBLE_WORD_WIDTH, &H0, sizeof(H0));
            H0 = CPU_TO_BE64(SHA384_H3);
            memcpy_s(&hisi_ctx->hash[6], DOUBLE_WORD_WIDTH, &H0, sizeof(H0));
            H0 = CPU_TO_BE64(SHA384_H4);
            memcpy_s(&hisi_ctx->hash[8], DOUBLE_WORD_WIDTH, &H0, sizeof(H0));
            H0 = CPU_TO_BE64(SHA384_H5);
            memcpy_s(&hisi_ctx->hash[10], DOUBLE_WORD_WIDTH, &H0, sizeof(H0));
            H0 = CPU_TO_BE64(SHA384_H6);
            memcpy_s(&hisi_ctx->hash[12], DOUBLE_WORD_WIDTH, &H0, sizeof(H0));
            H0 = CPU_TO_BE64(SHA384_H7);
            memcpy_s(&hisi_ctx->hash[14], DOUBLE_WORD_WIDTH, &H0, sizeof(H0));
            break;
        }
...
static s32 cryp_hash_create_mem(void)
{
    ...
    memset_s(&hash_mem, sizeof(hash_mem), 0x00, sizeof(hash_mem));
...
static s32 cryp_hash_chunk_copy(void *chunk, void *dma, u32 len, hash_chunk_src src)
{
    s32 ret = HI_FAILURE;
...
static u32 cryp_hash_pading(u32 block_size, u8 *msg, u32 tail_size, u32 total)
{
    ...
    memset_s(&msg[tail_size], HASH_BLOCK_SIZE_128 * 2, 0, pad_len);
...
static void * cryp_hash_create(hash_mode mode)
{
    ...
    memcpy_s(&hisi_ctx->mem, sizeof(crypto_mem), &hash_mem, sizeof(crypto_mem));
...
static void cryp_register_hash_default(u32 capacity, hash_mode mode, u32 blocksize, u32 hashlen)
{
    ...
    memset_s(&func, sizeof(capacity), 0 ,sizeof(capacity));
...
s32 cryp_hash_init(void)
{
    ...
    memset_s(&hash_descriptor, sizeof(hash_descriptor), 0, sizeof(hash_descriptor));
