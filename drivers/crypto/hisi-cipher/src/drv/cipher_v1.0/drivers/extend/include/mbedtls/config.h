...
//#define MBEDTLS_PLATFORM_STD_CALLOC          crypto_calloc /**< Default allocator to use, can be undefined */
//#define MBEDTLS_PLATFORM_STD_FREE            crypto_free  /**< Default free to use, can be undefined */
...
//#define MBEDTLS_PLATFORM_CALLOC_MACRO(n, size)        crypto_malloc(n * size) /**< Default allocator macro to use, can be undefined */
